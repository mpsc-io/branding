...
const CustomFooter=()=>
{
    ...
    <div className="footer-column-left">
        <h6>Get the App</h6>
        <a href="https://apps.apple.com/in/app/hoot-conferencing/id6443700600" target="_blank"><AppleButton></AppleButton></a>
        <br></br>
        <a href="https://play.google.com/store/apps/details?id=com.hoot.mobile" target="_blank"><GoogleButton></GoogleButton></a>
    </div>
</section>
);
